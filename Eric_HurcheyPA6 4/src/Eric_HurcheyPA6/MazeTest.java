 ...
 * This is where the maze game is being run.
 * 
 * Known Bugs:
...
//        Blob aBlob = new Blob(aGrid);
    ...
    public void solve() {
        ...
        //The below two system out print lines are what I used to test my Problem 2 and 3 codes
//        System.out.println(m.findAllMazePaths(0, 0));
//        System.out.println(m.findMazePathMin(0, 0));
    }
