/**
* This class tests the Station class that I created in the main package.
* It was a test that was provided already.
* Known Bugs: There is a slight bug where it will not pass two of the tests, other than that
* it pasts most tests.
*
* @author Eric Hurchey
